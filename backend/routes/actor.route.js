...
router.get('/visitantes', auth.secretario_presidente, (req, res) => actorController.getVisitantes(req, res));
router.get('/miembros', auth.aso_miembro, (req, res) => actorController.getMiembros(req, res));
router.get('/:actorId', auth.actor_registrado, (req, res) => actorController.getDatosByActorId(req, res));
