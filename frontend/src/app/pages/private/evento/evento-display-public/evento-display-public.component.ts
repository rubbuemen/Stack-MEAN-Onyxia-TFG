...
@Component({
  ...
  templateUrl: './evento-display-public.component.html',
  styles: [],
})
export class EventoDisplayPublicComponent implements OnDestroy, OnInit {
  public actividades: Actividad[];
  public evento: Evento;
  public inscripcion: InscripcionEvento;
  public tieneInscripcion: boolean = false;
    ...
    if (this.idObjectEvento !== undefined) {
      this.eventoService.getEvento(this.idObjectEvento).subscribe((evento) => {
        ...
        this.inscripcionEventoService
          .tieneInscripcion(this.idObjectEvento)
          .subscribe(
            (tieneInscripcion) => (this.tieneInscripcion = tieneInscripcion)
          );
        this.inscripcionEventoService
          .getEstadoInscripcionByEvento(this.idObjectEvento)
